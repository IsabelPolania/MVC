...
Class CiudadController{
    ...
    public function consult(){
        ...
        $sql="SELECT c.id_ciudad, c.nombre_ciu, d.nombre_dep FROM ciudad c,departamento d where c.id_dep=d.id_dep";
    ...
    public function postUpdate(){
        ...
        $sql="UPDATE ciudad SET nombre_ciu='$nombre_ciu' WHERE id_ciudad=$id_ciu";
